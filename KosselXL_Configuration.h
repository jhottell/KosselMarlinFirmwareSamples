...
#define STRING_CONFIG_H_AUTHOR "(Electronhacks)" // Who made the changes.
...
#define DELTA
  ...
  #define DELTA_SMOOTH_ROD_OFFSET 202 //220.1 // mm
  ...
  #define DELTA_RADIUS 181//(DELTA_SMOOTH_ROD_OFFSET-(DELTA_EFFECTOR_OFFSET)-(DELTA_CARRIAGE_OFFSET) + 1)

  // Print surface diameter/2 minus unreachable space (avoid collisions with vertical towers).
  #define DELTA_PRINTABLE_RADIUS 135
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { XYZ_STEPS, XYZ_STEPS, XYZ_STEPS, 650 }   // default steps per unit for PowerWasp
...
//##########################################
//##########################################
#define MANUAL_Z_HOME_POS 277.3 // Distance between the nozzle to printbed after homing
